...
<div class="container">
  ...
  <form action="index.php">
    ...
    <div class="form-group">
      <label for="emp_leavefromdt">From Date:</label>
      <input type="date" class="form-control" id="emp_leavefromdt" placeholder="Enter Leave From Date" name="emp_leavefromdt">
    </div> 
    <div class="form-group">
      <label for="emp_leavetodt">To Date:</label>
      <input type="date" class="form-control" id="emp_leavetodt" placeholder="Enter Leave To Date" name="emp_leavetodt">
    </div> 
 
    <div class="form-group">
      <label for="emp_credit">Credit:</label>
      <input type="number" class="form-control" id="emp_credit" placeholder="Enter Credit" name="emp_credit">
    </div>
    <div class="form-group">
      <label for="emp_balance">Balance:</label>
      <input type="number" class="form-control" id="emp_balance" placeholder="Enter Balance Credit" name="emp_balance">
    </div>
